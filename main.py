...
path = r"C:\Users\79859\PycharmProjects\pythonProject2\texture"
...
class Enemy(Entity):
    def __init__(self, **kwargs):
        super().__init__(parent=shootables_parent, model='cube', scale_y=2, origin_y=-.5, color=color.color(10,10,10,10), collider='box', **kwargs)
